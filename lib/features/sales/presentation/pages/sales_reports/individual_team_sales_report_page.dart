...
class _IndividualTeamSalesReportPageState extends ConsumerState<IndividualTeamSalesReportPage> {
  ...
  List<_TeamSale> get _filteredItems {
    ...
    return _allItems.where((item) =>
        ...
        item.date.toLowerCase().contains(query)).toList();
  }
  ...
  Future<void> _exportPdf() async {
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        header: (context) => pw.Column(
          ...
          children: [
            pw.Text('Individual Team Sales Report', style: pw.TextStyle(font: pw.Font.helveticaBold(), fontSize: 16)),
        ...
        build: (context) => [
          pw.TableHelper.fromTextArray(
            ...
            headers: ['S/N', 'Date', 'Staff', 'Type', 'Total'],
            data: [
              ...items.map((i) => [
                '${i.sn}', i.date, i.staff, i.type, _fmt(i.total),
              ]),
    ...
    final file = File('${dir.path}/IndividualTeamSalesReport_$_exportDateTime.pdf');
  ...
  Future<void> _exportExcel() async {
    ...
    excel.rename(excel.getDefaultSheet()!, 'Individual Team Sales');

    final sheet = excel['Individual Team Sales'];

    final headers = ['S/N', 'Date', 'Staff', 'Type', 'Total'];
    ...
    final dir = await getApplicationDocumentsDirectory();
    final file = File('${dir.path}/IndividualTeamSalesReport_$_exportDateTime.xlsx');
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Search staff, date or type...',
  ...
  Widget _buildTable(List<_TeamSale> items) {
    return Container(
  ...
  Widget _buildTableRow(_TeamSale item, int index) {
